...
def pbItemBall(item, quantity = 1)
  random = Randomizer.random_item(item)
  item = Randomizer.activated? ? GameData::Item.get(random).id_number : GameData::Item.get(item).id_number
