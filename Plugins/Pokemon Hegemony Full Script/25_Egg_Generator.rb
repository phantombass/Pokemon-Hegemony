...
def random_eggs
  ...
  :SKORUPI,:FOMANTIS,:DEWPIDER,:BUNEARY,:TYNAMO,:DELIBIRD,:REMORAID,:WOOLOO,:NICKIT,:SKWOVET,:DHELMISE,:EKANS,:CRYOGONAL,:CUBCHOO,:WISHIWASHI,:DEINO,:TRAPINCH,:BELDUM,:BAGON,:LARVITAR,:DRATINI,:EEVEE,:GIBLE,:NOIBAT,:JANGMOO,:DREEPY,:RIOLU,:TYROGUE,:CROAGUNK,:GLIGAR,:HATENNA,:ZIGZAGOON,:ROOKIDEE,:JOLTIK]
  eggs = []
  pbEachPokemon { |poke,_box|
    mon = poke.species
    evo = GameData::Species.get(mon).get_baby_species
...
def generate_random_egg
  ...
  regionals = [:CUBONE,:DARUMAKA,:MEOWTH,:PONYTA,:CORSOLA,:FARFETCHD,:GEODUDE,:STUNFISK,:GRIMER,:KOFFING,:ZIGZAGOON]
  reg_rand = rand(10)
