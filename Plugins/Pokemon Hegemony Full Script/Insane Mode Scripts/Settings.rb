...
class Restrictions
  ...
  BANNED_MOVES = [:CALMMIND,:BULKUP,:SWORDSDANCE,:NASTYPLOT,:STATICSURGE,:TAILGLOW,:WORKUP,:HOWL,:AGILITY,:COSMICPOWER,:DEFENDORDER,
    ...
    :SHARPEN,:HARDEN,:ACUPRESSURE,:COPYCAT,:DOODLE
  ]

  ABILITY_CHANGES = {
    :UNSHAKEN => [:SIMPLE,:BEASTBOOST,:MOXIE,:GRIMNEIGH,:CHILLINGNEIGH,:CONTRARY,:DEFIANT,:COMPETITIVE,:SPEEDBOOST,:ANGERSHELL,:WEAKARMOR,:GUARDDOG,:STEAMENGINE,:WATERCOMPACTION],
    :TELEPATHY => [:MISTYSURGE,:PSYCHICSURGE,:ELECTRICSURGE,:GRASSYSURGE,:TOXICSURGE,:SEEDSOWER,:DIMENSIONBLOCK,:MOODY],
