...
class Restrictions
  ...
  BANNED_MOVES = [:CALMMIND,:BULKUP,:SWORDSDANCE,:NASTYPLOT,:STATICSURGE,:TAILGLOW,:WORKUP,:HOWL,:AGILITY,:COSMICPOWER,:DEFENDORDER,
    ...
    :SHARPEN,:HARDEN,:ACUPRESSURE,:COPYCAT,:DOODLE,:COURTCHANGE,:DESTINYBOND,:POWDER,:SHEDTAIL,:DECORATE
  ]

  ABILITY_CHANGES = {
    :UNSHAKEN => [:PROTEAN,:LIBERO,:SIMPLE,:BEASTBOOST,:MOXIE,:GRIMNEIGH,:CHILLINGNEIGH,:CONTRARY,:DEFIANT,:COMPETITIVE,:SPEEDBOOST,:ANGERSHELL,:WEAKARMOR,:GUARDDOG,:STEAMENGINE,:WATERCOMPACTION],
