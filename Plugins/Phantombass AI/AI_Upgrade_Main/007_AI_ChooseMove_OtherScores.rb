...
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:shiny_target,
...
#===============================================================================
AIHandlers::GeneralMoveScore.add(:shadow_moves,
...
#===============================================================================
AIHandlers::GeneralMoveScore.add(:thawing_move_when_frozen,
  proc { |score, move, user, ai, battle|
...
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:priority_move_against_faster_target,
  proc { |score, move, user, target, ai, battle|
    if ai.trainer.high_skill? && target.faster_than?(user) && move.rough_priority(user) > 0
      ...
      ai.each_foe_battler(user.side) do |b, i|
        next if !b.has_move_with_function?("0AB")
...
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:target_can_Magic_Coat_or_Bounce_move,
  proc { |score, move, user, target, ai, battle|
...
AIHandlers::GeneralMoveScore.add(:any_foe_can_Magic_Coat_or_Bounce_move,
  proc { |score, move, user, ai, battle|
    if move.statusMove? && move.move.canMagicCoat? && move.pbTarget(user.battler).num_targets == 0
      ...
      ai.each_foe_battler(user.side) do |b, i|
        ...
        if b.has_active_ability?(:MAGICBOUNCE) && !battle.moldBreaker
          ...
          break
        elsif b.has_move_with_function?("0B1") &&
...
#===============================================================================
AIHandlers::GeneralMoveScore.add(:any_battler_can_Snatch_move,
  proc { |score, move, user, ai, battle|
    if move.statusMove? && move.move.canSnatch?
      ai.each_battler do |b, i|
        next if b.index == user.index
        next if b.effects[PBEffects::SkyDrop] >= 0
        next if !b.has_move_with_function?("0B2")
        old_score = score
        score -= 7
...
#===============================================================================
AIHandlers::GeneralMoveScore.add(:good_move_for_choice_item,
  proc { |score, move, user, ai, battle|
    ...
    if move.statusMove? && move.function_code != "0F2"
      score -= 25
...
# more (desperate).
#===============================================================================
AIHandlers::GeneralMoveScore.add(:damaging_move_and_either_side_no_reserves,
  proc { |score, move, user, ai, battle|
...
# user.
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:target_can_powder_fire_moves,
  proc { |score, move, user, target, ai, battle|
    if ai.trainer.high_skill? && move.rough_type == :FIRE &&
       target.has_move_with_function?("148") &&
...
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:target_can_make_moves_Electric_and_be_immune,
  proc { |score, move, user, target, ai, battle|
    next score if !ai.trainer.high_skill?
    next score if !target.has_move_with_function?("145") &&
                  !(move.rough_type == :NORMAL && target.has_move_with_function?("146"))
...
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:target_semi_invulnerable,
  proc { |score, move, user, target, ai, battle|
    if ai.trainer.medium_skill? && move.rough_accuracy > 0 &&
      ...
      if priority > 0 || (priority == 0 && user.faster_than?(target))   # User goes first
        ...
        if ai.trainer.high_skill?
          ...
          elsif target.battler.inTwoTurnAttack?("0CA")
            miss = false if move.move.hitsDiggingTargets?
          elsif target.battler.inTwoTurnAttack?("0CB")
...
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:predicted_accuracy,
  proc { |score, move, user, target, ai, battle|
...
# target.
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:predicted_damage,
  proc { |score, move, user, target, ai, battle|
...
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:external_flinching_effects,
  proc { |score, move, user, target, ai, battle|
...
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:thawing_move_against_frozen_target,
  proc { |score, move, user, target, ai, battle|
...
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:trigger_target_ability_or_item_upon_hit,
  proc { |score, move, user, target, ai, battle|
    if ai.trainer.high_skill? && move.damagingMove? && target.effects[PBEffects::Substitute] == 0
      if target.ability_active?
        if BattleHandlers::TargetAbilityOnHit[target.ability] ||
           (BattleHandlers::TargetAbilityAfterMoveUse[target.ability] &&
      ...
      if target.item_active?
        if BattleHandlers::TargetItemOnHit[target.item] ||
           (BattleHandlers::TargetItemAfterMoveUse[target.item] &&
           (!user.has_active_ability?(:SHEERFORCE) || move.move.addlEffect == 0))
          old_score = score
          score += 8
...
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:trigger_user_ability_upon_hit,
  proc { |score, move, user, target, ai, battle|
    if ai.trainer.high_skill? && user.ability_active? && move.damagingMove? &&
      ...
      if (BattleHandlers::UserAbilityOnHit[user.ability] && move.move.contactMove?) ||
         BattleHandlers::UserAbilityEndOfMove[user.ability]
        old_score = score
        score += 8
...
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:knocking_out_a_destiny_bonder_or_grudger,
  proc { |score, move, user, target, ai, battle|
...
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:damaging_a_raging_target,
  proc { |score, move, user, target, ai, battle|
...
#===============================================================================
AIHandlers::GeneralMoveAgainstTargetScore.add(:damaging_a_biding_target,
  proc { |score, move, user, target, ai, battle|
...
#===============================================================================
AIHandlers::GeneralMoveScore.add(:dance_move_against_dancer,
  proc { |score, move, user, ai, battle|
