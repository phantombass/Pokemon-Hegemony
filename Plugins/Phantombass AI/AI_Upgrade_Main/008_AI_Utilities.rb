...
class NewAI
  ...
  # Neutralizing Gas).
  # pkmn is either a NewAI::AIBattler or a Pokemon.
  # move is a Battle::Move or a Pokemon::Move.
  def pokemon_can_absorb_move?(pkmn, move, move_type)
    return false if pkmn.is_a?(NewAI::AIBattler) && !pkmn.ability_active?
    ...
    when :WONDERGUARD
      types = pkmn.types
      types = pkmn.pbTypes(true) if pkmn.is_a?(NewAI::AIBattler)
  ...
  def pokemon_can_be_poisoned?(pkmn)
    ...
    return false if pkmn.hasAbility?(:FAIRYBUBBLE)
  ...
  def pokemon_airborne?(pkmn)
    ...
    return true if pkmn.hasAbility?(:MULTITOOL)
...
AIHandlers::AbilityRanking.add(:BLAZE,
...
AIHandlers::AbilityRanking.add(:CUTECHARM,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.copy(:CUTECHARM, :RIVALRY)

AIHandlers::AbilityRanking.add(:FRIENDGUARD,
  proc { |ability, score, battler, ai|
    has_ally = false
...
AIHandlers::AbilityRanking.copy(:FRIENDGUARD, :HEALER, :SYMBOISIS, :TELEPATHY)

AIHandlers::AbilityRanking.add(:GALEWINGS,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.add(:HUGEPOWER,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.copy(:HUGEPOWER, :PUREPOWER)

AIHandlers::AbilityRanking.add(:IRONFIST,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.add(:LIQUIDVOICE,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.add(:MEGALAUNCHER,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.add(:OVERGROW,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.add(:PRANKSTER,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.add(:PUNKROCK,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.add(:RECKLESS,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.add(:ROCKHEAD,
  proc { |ability, score, battler, ai|
    next score if battler.check_for_move { |m| m.recoilMove? && !m.function == "10B" }
    next 0
  }
)

AIHandlers::AbilityRanking.add(:RUNAWAY,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.add(:SANDFORCE,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.add(:SKILLLINK,
  proc { |ability, score, battler, ai|
    next score if battler.check_for_move { |m| m.function == "0C0" }
    next 0
  }
)

AIHandlers::AbilityRanking.add(:STEELWORKER,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.add(:SWARM,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.add(:TORRENT,
  proc { |ability, score, battler, ai|
...
AIHandlers::AbilityRanking.add(:TRIAGE,
  proc { |ability, score, battler, ai|
...
AIHandlers::ItemRanking.add(:ADAMANTORB,
...
AIHandlers::ItemRanking.add(:AGUAVBERRY,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.add(:ASSAULTVEST,
  proc { |item, score, battler, ai|
    if ai.trainer.high_skill?
      score += 1 if !battler.check_for_move { |m| m.statusMove? }
    end
    next score
  }
)

AIHandlers::ItemRanking.add(:BERRYJUICE,
  proc { |item, score, battler, ai|
    next [10 - (battler.totalhp / 15), 1].max
  }
)
=begin
AIHandlers::ItemRanking.add(:BIGROOT,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.add(:BINDINGBAND,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.copy(:BINDINGBAND, :GRIPCLAW)
=end
AIHandlers::ItemRanking.add(:BLACKSLUDGE,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.add(:CHESTOBERRY,
  proc { |item, score, battler, ai|
    if ai.trainer.high_skill?
      score += 1 if battler.has_move_with_function?("0D9")
    end
    next score
  }
)

AIHandlers::ItemRanking.add(:CHOICEBAND,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.copy(:CHOICEBAND, :MUSCLEBAND)

AIHandlers::ItemRanking.add(:CHOICESPECS,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.copy(:CHOICESPECS, :WISEGLASSES)

AIHandlers::ItemRanking.add(:DEEPSEASCALE,
  proc { |item, score, battler, ai|
...
=begin
AIHandlers::ItemRanking.add(:DAMPROCK,
  proc { |item, score, battler, ai|
...
=end
AIHandlers::ItemRanking.add(:DEEPSEATOOTH,
  proc { |item, score, battler, ai|
    next score if battler.battler.isSpecies?(:CLAMPERL) &&
...
AIHandlers::ItemRanking.add(:ELECTRICSEED,
  proc { |item, score, battler, ai|
    next score if battler.check_for_move { |m| m.function == "154" }
    next 0
  }
)

AIHandlers::ItemRanking.add(:EVIOLITE,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.add(:FIGYBERRY,
  proc { |item, score, battler, ai|
    if Settings::MECHANICS_GENERATION == 7   # Heals 50%
      score += 2
    elsif Settings::MECHANICS_GENERATION <= 6   # Heals 12.5%
...
AIHandlers::ItemRanking.add(:FLAMEORB,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.add(:FULLINCENSE,
  proc { |item, score, battler, ai|
    if ai.trainer.high_skill?
...
AIHandlers::ItemRanking.copy(:FULLINCENSE, :LAGGINGTAIL)

AIHandlers::ItemRanking.add(:GRASSYSEED,
  proc { |item, score, battler, ai|
    next score if battler.check_for_move { |m| m.function == "155" }
    next 0
  }
)

AIHandlers::ItemRanking.add(:GRISEOUSORB,
  proc { |item, score, battler, ai|
...
=begin
AIHandlers::ItemRanking.add(:HEATROCK,
  proc { |item, score, battler, ai|
...
=end
AIHandlers::ItemRanking.add(:IAPAPABERRY,
  proc { |item, score, battler, ai|
    if Settings::MECHANICS_GENERATION == 7   # Heals 50%
      score += 2
    elsif Settings::MECHANICS_GENERATION <= 6   # Heals 12.5%
...
=begin
AIHandlers::ItemRanking.add(:ICYROCK,
  proc { |item, score, battler, ai|
...
=end
AIHandlers::ItemRanking.add(:WEATHERROCK,
  proc { |item, score, battler, ai|
    next score if battler.check_for_move { |m| m.is_a?(PokeBattle_WeatherMove) }
    next 0
  }
)

AIHandlers::ItemRanking.add(:IRONBALL,
  proc { |item, score, battler, ai|
    next 0 if battler.has_move_with_function?("0F7")
    next score
  }
)

AIHandlers::ItemRanking.add(:KINGSROCK,
  proc { |item, score, battler, ai|
    if ai.trainer.high_skill?
...
AIHandlers::ItemRanking.copy(:KINGSROCK, :RAZORFANG)

AIHandlers::ItemRanking.add(:LEEK,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.copy(:LEEK, :STICK)

AIHandlers::ItemRanking.add(:LIGHTBALL,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.add(:LIGHTCLAY,
  proc { |item, score, battler, ai|
    next score if battler.check_for_move do |m|
      ["0A2","0A3","167"].include?(m.function)
    end
    next 0
  }
)

AIHandlers::ItemRanking.add(:LUCKYPUNCH,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.add(:LUSTROUSORB,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.add(:MAGOBERRY,
  proc { |item, score, battler, ai|
    if Settings::MECHANICS_GENERATION == 7   # Heals 50%
      score += 2
    elsif Settings::MECHANICS_GENERATION <= 6   # Heals 12.5%
...
AIHandlers::ItemRanking.add(:METALPOWDER,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.copy(:METALPOWDER, :QUICKPOWDER)

AIHandlers::ItemRanking.add(:MISTYSEED,
  proc { |item, score, battler, ai|
    next score if battler.check_for_move { |m| m.function == "156" }
    next 0
  }
)

AIHandlers::ItemRanking.add(:ORANBERRY,
  proc { |item, score, battler, ai|
    next [10 - (battler.totalhp / 8), 1].max
  }
)

AIHandlers::ItemRanking.add(:POWERHERB,
  proc { |item, score, battler, ai|
    next score if battler.check_for_move do |m|
      m.is_a?(PokeBattle_TwoTurnMove) &&
      !m.function == "0CE"
    end
    next 0
  }
...
AIHandlers::ItemRanking.add(:PSYCHICSEED,
  proc { |item, score, battler, ai|
    next score if battler.check_for_move { |m| m.function == "173" }
    next 0
  }
)

AIHandlers::ItemRanking.add(:RINGTARGET,
  proc { |item, score, battler, ai|
    has_immunity = false
...
=begin
AIHandlers::ItemRanking.add(:SMOOTHROCK,
  proc { |item, score, battler, ai|
...
=end
AIHandlers::ItemRanking.add(:SOULDEW,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.add(:TERRAINEXTENDER,
  proc { |item, score, battler, ai|
    next score if battler.check_for_move do |m|
      m.is_a?(PokeBattle_TerrainMove)
    end
    next 0
  }
)

AIHandlers::ItemRanking.add(:THICKCLUB,
  proc { |item, score, battler, ai|
...
AIHandlers::ItemRanking.add(:THROATSPRAY,
  proc { |item, score, battler, ai|
    next score if battler.check_for_move { |m| m.soundMove? }
    next 0
  }
...
AIHandlers::ItemRanking.add(:TOXICORB,
  proc { |item, score, battler, ai|
    next 0 if battler.status != :NONE
...
AIHandlers::ItemRanking.add(:WHITEHERB,
  proc { |item, score, battler, ai|
    if ai.trainer.high_skill?
      score += 1 if battler.has_move_with_function?("035")
    end
    next score
  }
)

AIHandlers::ItemRanking.add(:WIKIBERRY,
  proc { |item, score, battler, ai|
    if Settings::MECHANICS_GENERATION == 7   # Heals 50%
      score += 2
    elsif Settings::MECHANICS_GENERATION <= 6   # Heals 12.5%
...
AIHandlers::ItemRanking.add(:ZOOMLENS,
  proc { |item, score, battler, ai|
    if ai.trainer.high_skill?
      score += 1 if battler.stages[:ACCURACY] < 0
      battler.battler.eachMove do |m|
        next if m.accuracy == 0 || m.function == "070"
...
AIHandlers::ItemRanking.addIf(:type_boosting_items,
  proc { |item|
    next [:BLACKBELT, :BLACKGLASSES, :CHARCOAL, :DRAGONFANG, :HARDSTONE,
          ...
          :ICICLEPLATE, :INSECTPLATE, :IRONPLATE, :MEADOWPLATE, :MINDPLATE,
          :PIXIEPLATE, :SKYPLATE, :SPLASHPLATE, :SPOOKYPLATE, :STONEPLATE,
          :TOXICPLATE, :ZAPPLATE, :STELLARPLATE,
