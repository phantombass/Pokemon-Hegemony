...
#
#===============================================================================
AIHandlers::MoveFailureCheck.add("0D9",
...
AIHandlers::MoveEffectScore.add("0D9",
...
#
#===============================================================================
AIHandlers::MoveFailureCheck.add("0D5",
  proc { |move, user, ai, battle|
    next !user.battler.canHeal?
  }
)
AIHandlers::MoveEffectScore.add("0D5",
  proc { |score, move, user, ai, battle|
    # Consider how much HP will be restored
    if ai.trainer.has_skill_flag?("HPAware")
...
#
#===============================================================================
AIHandlers::MoveFailureCheck.copy("0D5",
                                            "0D8")
AIHandlers::MoveEffectScore.add("0D8",
  proc { |score, move, user, ai, battle|
    # Consider how much HP will be restored
    score = AIHandlers.apply_move_effect_score("0D5",
...
AIHandlers::MoveFailureCheck.copy("0D5",
                                            "16D")
AIHandlers::MoveEffectScore.add("16D",
  proc { |score, move, user, ai, battle|
    # Consider how much HP will be restored
    score = AIHandlers.apply_move_effect_score("0D5",
       score, move, user, ai, battle)
...
AIHandlers::MoveFailureCheck.copy("0D5",
                                            "0D6")
AIHandlers::MoveEffectScore.add("0D6",
  proc { |score, move, user, ai, battle|
    # Consider how much HP will be restored
    score = AIHandlers.apply_move_effect_score("0D5",
       score, move, user, ai, battle)
...
#
#===============================================================================
AIHandlers::MoveFailureAgainstTargetCheck.add("15B",
  proc { |move, user, target, ai, battle|
    next !user.battler.canHeal? || target.status == :NONE
  }
)
AIHandlers::MoveEffectAgainstTargetScore.add("15B",
...
#
#===============================================================================
AIHandlers::MoveFailureAgainstTargetCheck.add("160",
  proc { |move, user, target, ai, battle|
...
AIHandlers::MoveEffectAgainstTargetScore.add("160",
  proc { |score, move, user, target, ai, battle|
...
#
#===============================================================================
AIHandlers::MoveEffectAgainstTargetScore.add("0DD",
  proc { |score, move, user, target, ai, battle|
...
#
#===============================================================================
AIHandlers::MoveFailureAgainstTargetCheck.add("0DE",
  proc { |move, user, target, ai, battle|
    next !target.battler.asleep?
  }
)
AIHandlers::MoveEffectAgainstTargetScore.copy("0DD",
                                                        "0DE")

#===============================================================================
#
#===============================================================================
AIHandlers::MoveEffectAgainstTargetScore.add("14F",
  proc { |score, move, user, target, ai, battle|
    rough_dmg = move.rough_damage
    if target.has_active_ability?(:LIQUIDOOZE)
      score -= 20 if rough_dmg < target.hp
...
#
#===============================================================================
AIHandlers::MoveFailureAgainstTargetCheck.add("17E",
  proc { |move, user, target, ai, battle|
    next !target.battler.canHeal?
  }
)
AIHandlers::MoveEffectAgainstTargetScore.add("17E",
  proc { |score, move, user, target, ai, battle|
...
#
#===============================================================================
AIHandlers::MoveFailureAgainstTargetCheck.add("189",
  proc { |move, user, target, ai, battle|
    next !target.battler.canHeal? && target.status == :NONE
  }
)
AIHandlers::MoveEffectAgainstTargetScore.add("189",
  proc { |score, move, user, target, ai, battle|
    # Consider how much HP will be restored
    score = AIHandlers.apply_move_effect_score("17E",
       score, move, user, ai, battle)
    # Check whether an existing status problem will be removed
...
#
#===============================================================================
AIHandlers::MoveFailureAgainstTargetCheck.add("0DF",
  proc { |move, user, target, ai, battle|
    next !target.battler.canHeal?
  }
)
AIHandlers::MoveEffectAgainstTargetScore.add("0DF",
  proc { |score, move, user, target, ai, battle|
...
#
#===============================================================================
AIHandlers::MoveFailureAgainstTargetCheck.copy("0DF",
                                                         "16E")
AIHandlers::MoveEffectAgainstTargetScore.add("16E",
  proc { |score, move, user, target, ai, battle|
    next NewAI::MOVE_USELESS_SCORE if user.opposes?(target)
    # Consider how much HP will be restored
    if ai.trainer.has_skill_flag?("HPAware")
      if target.hp >= target.totalhp * 0.5
        score -= 10
...
#
#===============================================================================
AIHandlers::MoveFailureCheck.add("0D7",
  proc { |move, user, ai, battle|
    next battle.positions[user.index].effects[PBEffects::Wish] > 0
  }
)
AIHandlers::MoveEffectScore.add("0D7",
  proc { |score, move, user, ai, battle|
    # Consider how much HP will be restored
    if ai.trainer.has_skill_flag?("HPAware")
      if user.hp >= user.totalhp * 0.5
...
#
#===============================================================================
AIHandlers::MoveFailureCheck.add("0DA",
  proc { |move, user, ai, battle|
    next user.effects[PBEffects::AquaRing]
  }
)
AIHandlers::MoveEffectScore.add("0DA",
  proc { |score, move, user, ai, battle|
    score += 15
    score += 5 if user.has_active_item?(:BIGROOT)
    next score
...
#
#===============================================================================
AIHandlers::MoveFailureCheck.add("0DB",
  proc { |move, user, ai, battle|
    next user.effects[PBEffects::Ingrain]
  }
)
AIHandlers::MoveEffectScore.add("0DB",
  proc { |score, move, user, ai, battle|
    score += 8
...
#
#===============================================================================
AIHandlers::MoveFailureAgainstTargetCheck.add("10F",
  proc { |move, user, target, ai, battle|
    next !target.battler.asleep? || target.effects[PBEffects::Nightmare]
  }
)
AIHandlers::MoveEffectAgainstTargetScore.add("10F",
  proc { |score, move, user, target, ai, battle|
    next NewAI::MOVE_USELESS_SCORE if target.statusCount <= 1
...
#
#===============================================================================
AIHandlers::MoveFailureAgainstTargetCheck.add("0DC",
  proc { |move, user, target, ai, battle|
...
AIHandlers::MoveEffectAgainstTargetScore.add("0DC",
  proc { |score, move, user, target, ai, battle|
    score += 15
    # Prefer early on
...
#
#===============================================================================
AIHandlers::MoveEffectScore.add("0FC",
  proc { |score, move, user, ai, battle|
...
#
#===============================================================================
AIHandlers::MoveFailureCheck.add("170",
  proc { |move, user, ai, battle|
    next !battle.moldBreaker && battle.pbCheckGlobalAbility(:DAMP)
  }
)
AIHandlers::MoveEffectScore.copy("0FC",
                                           "170")

#===============================================================================
#
#===============================================================================
AIHandlers::MoveFailureCheck.copy("170",
                                            "0E0")
AIHandlers::MoveEffectScore.add("0E0",
  proc { |score, move, user, ai, battle|
...
#
#===============================================================================
AIHandlers::MoveFailureCheck.copy("0E0",
                                            "196")
AIHandlers::MoveBasePower.add("196",
  proc { |power, move, user, target, ai, battle|
    power = power * 3 / 2 if battle.field.terrain == :Misty
    next power
  }
)
AIHandlers::MoveEffectScore.copy("0E0",
                                           "196")

#===============================================================================
#
#===============================================================================
AIHandlers::MoveBasePower.add("0E1",
  proc { |power, move, user, target, ai, battle|
    next user.hp
  }
)
...
#
#===============================================================================
AIHandlers::MoveEffectAgainstTargetScore.add("0E2",
  proc { |score, move, user, target, ai, battle|
    score -= 20   # User will faint, don't prefer this move
...
#
#===============================================================================
AIHandlers::MoveFailureCheck.add("0E3",
  proc { |move, user, ai, battle|
    next !battle.pbCanChooseNonActive?(user.index)
  }
)
AIHandlers::MoveEffectScore.add("0E3",
  proc { |score, move, user, ai, battle|
    score -= 20   # User will faint, don't prefer this move
    ...
    if ai.trainer.medium_skill?
      ...
      next NewAI::MOVE_USELESS_SCORE if !need_healing
      score += 10
    end
    if ai.trainer.has_skill_flag?("HPAware")
      score -= 10 if user.hp >= user.totalhp * 0.5
...
#
#===============================================================================
AIHandlers::MoveFailureCheck.copy("0E3",
                                            "0E4")
AIHandlers::MoveEffectScore.copy("0E3",
                                           "0E4")

#===============================================================================
#
#===============================================================================
AIHandlers::MoveFailureAgainstTargetCheck.add("0E5",
  proc { |move, user, target, ai, battle|
    next true if target.effects[PBEffects::PerishSong] > 0
    next false if !target.ability_active?
    next BattleHandlers.triggerMoveImmunityTargetAbility(target.ability, user.battler, target.battler,
                                                    move.move, move.rough_type, battle, false)
  }
)
AIHandlers::MoveEffectScore.add("0E5",
  proc { |score, move, user, ai, battle|
    score -= 15
    ...
    if ai.trainer.medium_skill?
      ...
      ai.each_battler do |b|
        next if AIHandlers.move_will_fail_against_target?("0E5",
      ...
      next NewAI::MOVE_USELESS_SCORE if foes_affected == 0
...
#
#===============================================================================
AIHandlers::MoveEffectScore.add("0E6",
  proc { |score, move, user, ai, battle|
    score -= 25
    # Check whether user is faster than its foe(s) and could use this move
    user_faster_count = 0
