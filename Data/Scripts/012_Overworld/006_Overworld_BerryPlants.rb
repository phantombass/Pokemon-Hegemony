...
def pbPickBerry(berry, qty = 1)
  ...
  if $game_switches[LvlCap::Expert]
    case berry_id
    when :ORANBERRY,:PECHABERRY,:RAWSTBERRY,:ASPEARBERRY,:CHERIBERRY
      qty = 20 + rand(61)
    when :SITRUSBERRY,:LUMBERRY,:CHESTOBERRY
      qty = 10 + rand(31)
    when :ROWAPBERRY,:JABOCABERRY
      qty = 1 + rand(3)
    when :WIKIBERRY,:AGUAVBERRY,:IAPAPABERRY,:FIGYBERRY,:MAGOBERRY
      qty = 10 + rand(11)
    when :CUSTAPBERRY
      qty = 1
    else
    ...
    qty = ([:ORANBERRY,:PECHABERRY,:RAWSTBERRY,:ASPEARBERRY,:CHERIBERRY].include?(berry)) ? 2 + rand(4) : 6
  end
